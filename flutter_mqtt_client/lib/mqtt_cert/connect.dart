...
final client = MqttServerClient('thermal.luci.ai', '');
...
class MyClient {
  Future<int> main() async {
    ...
    // final currDir = '${path.current}mqtt_cert${path.separator}';
    final context = SecurityContext.defaultContext;
    // context.setTrustedCertificates(currDir + path.join('mosquitto.org.crt'));
    context.setTrustedCertificates(
        '/Users/tongweizj/workspace/gitYoese/MaxTutorial_Flutter/fluttermqttclient/lib/mqtt_cert/thermal.luci.ai.ca.crt');
    ...
    builder.addString('Hello from mqtt_demo_max_client');
